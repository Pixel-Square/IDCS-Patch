...
admin.site.register(models.ApplicationRoleHierarchy)
admin.site.register(models.ApplicationRoleHierarchyStage)
admin.site.register(models.ApplicationRoleHierarchyStageRole)
admin.site.register(models.ApplicationRoleHierarchyStageUser)
