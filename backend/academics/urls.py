...
urlpatterns = [
    ...
    path('staffs/shuffle-internal-id/', StaffInternalIdShuffleView.as_view()),
    path('staffs/shuffle-internal-id', StaffInternalIdShuffleView.as_view()),
    path('staff/shuffle-internal-id/', StaffInternalIdShuffleView.as_view()),
    path('staff/shuffle-internal-id', StaffInternalIdShuffleView.as_view()),
    path('shuffle-internal-id/', StaffInternalIdShuffleView.as_view()),
    path('shuffle-internal-id', StaffInternalIdShuffleView.as_view()),
